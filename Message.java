...
public Message(String messageType) {
    if (messageType.equals(MessageConstants.MESSAGE_INTERESTED) || 
        messageType.equals(MessageConstants.MESSAGE_NOT_INTERESTED) ||
        messageType.equals(MessageConstants.MESSAGE_CHOKE) || 
        messageType.equals(MessageConstants.MESSAGE_UNCHOKE) ||
        messageType.equals(MessageConstants.MESSAGE_DOWNLOADED)) {
        
        setMessageLength(1);
        setMessageType(messageType);
        this.payload = null;
    } else {
        String errorMessage = "Message Constructor - Wrong constructor selected";
        logAndShowInConsole(errorMessage);
